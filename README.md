# cloud-itonami-municipality-sau-riyadh

Municipal-ordinance compliance catalog for **Riyadh** — the
THIRTY-NINTH municipality-level entry alongside
...
Riyadh is the axis's second Gulf entry (after Abu Dhabi) and the
first for Saudi Arabia, the largest Arab economy.

## Sourcing note

`alriyadh.gov.sa` (the municipality's own portal) offered only a
portal/navigation hub with no specific regulation numbers or founding
dates. `balady.gov.sa`'s (Ministry of Municipal and Rural Affairs and
...
Arabic-script font-subsetting. This catalog's entries instead cite
the Lexis Middle East legal database and `rcrc.gov.sa` (the Royal
Commission for Riyadh City's own official domain).

## Scope

A **read-only reference/archive** catalog — not an Advisor⊣Governor
actuation actor. It proposes or executes nothing on Riyadh
Municipality's or the Royal Commission for Riyadh City's behalf.
...
Both entries directly confirmed: the **Law of Municipalities and
Villages** (Royal Decree No. M/5/1397, 10 February 1977, via the
Lexis Middle East legal database) and the **Establishment of the
Supreme Authority of Riyadh Development** (Cabinet Decision No. 717,
20 June 1974, via rcrc.gov.sa, the Royal Commission for Riyadh City's
own official domain).
...
festivals and heritage sites for Riyadh:
...
remains the Kingdom of Saudi Arabia's; this repo stores only citation
